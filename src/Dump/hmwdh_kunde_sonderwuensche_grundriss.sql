...
--
-- Table structure for table `kunde_sonderwuensche_grundriss`
--

DROP TABLE IF EXISTS `kunde_sonderwuensche_grundriss`;
...
--
-- Dumping data for table `kunde_sonderwuensche_grundriss`
--

LOCK TABLES `kunde_sonderwuensche_grundriss` WRITE;
/*!40000 ALTER TABLE `kunde_sonderwuensche_grundriss` DISABLE KEYS */;
/*!40000 ALTER TABLE `kunde_sonderwuensche_grundriss` ENABLE KEYS */;
UNLOCK TABLES;
