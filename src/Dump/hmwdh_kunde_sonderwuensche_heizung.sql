...
--
-- Table structure for table `kunde_sonderwuensche_heizung`
--

DROP TABLE IF EXISTS `kunde_sonderwuensche_heizung`;
...
CREATE TABLE `kunde_sonderwuensche_heizung` (
  ...
  KEY `kunde_sonderwünsche_heizung_sonderwünsche_heizung_id_fk` (`sonderwuensche_id`),
...
--
-- Dumping data for table `kunde_sonderwuensche_heizung`
--

LOCK TABLES `kunde_sonderwuensche_heizung` WRITE;
/*!40000 ALTER TABLE `kunde_sonderwuensche_heizung` DISABLE KEYS */;
/*!40000 ALTER TABLE `kunde_sonderwuensche_heizung` ENABLE KEYS */;
UNLOCK TABLES;
