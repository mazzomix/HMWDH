...
CREATE TABLE `kunde_sonderwuensche_sanitaerinstallation` (
  ...
  KEY `sonderwünsche_sanitärinstallation_id_fk` (`sonderwünsche_id`),
  ...
  CONSTRAINT `sonderwünsche_sanitärinstallation_id_fk` FOREIGN KEY (`sonderwünsche_id`) REFERENCES `sonderwuensche_sanitaerinstallation` (`id`)
